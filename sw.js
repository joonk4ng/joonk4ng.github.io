...
const urlsToCache = [
  ...
  './pdfjskit/pdfjs/web/viewer.css',
  './pdfjskit/pdfjs/web/wasm/openjpeg.wasm',
  './pdfjskit/pdfjs/web/wasm/qcms_bg.wasm',
  './pdfjskit/pdfjs/web/wasm/openjpeg_nowasm_fallback.js',
  './assets/main-*.js',
  './assets/vendor-*.js',
  './assets/pdf-*.js',
  './assets/xlsx-*.js',
